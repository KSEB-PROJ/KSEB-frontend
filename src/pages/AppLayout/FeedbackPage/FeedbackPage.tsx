...
import {faUpload, faPlay, faRobot, faAngleRight, faPersonCirclePlus} from '@fortawesome/free-solid-svg-icons';
        ...
        <div className={styles.container}>
            <div className={styles.top}>
                ...
                <div className={styles.pwrapper}>
                    <FontAwesomeIcon icon={faPersonCirclePlus} className={styles.plus}/>
